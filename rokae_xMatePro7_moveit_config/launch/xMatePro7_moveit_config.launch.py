...
def generate_launch_description():
    ...
    robot_description_kinematics = PathJoinSubstitution(
        [FindPackageShare("rokae_xMatePro7_moveit_config"), "config", "kinematics.yaml"]
    )
    ...
    ompl_planning_yaml = load_yaml("rokae_xMatePro7_moveit_config", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    moveit_simple_controllers_yaml = load_yaml(
        "rokae_xMatePro7_moveit_config", "config/simple_moveit_controllers.yaml"
    )
