...
//         arm.setPoseReferenceFrame("xMateCR7_base");    //xMateCR7_base，xMateSR4_base，base_link，xMatePro7_base,xMatePro3_base
...
//         std::vector<double> joint_target = {0.5, 0.5, 0.5, 0.5, 0.5, 0.5};   //六轴测试数据  弧度
...
//                 }
//             } else {
//                 RCLCPP_ERROR(this->get_logger(), "轨迹不安全，请手动调整机械臂位置！");
//                 // 可以选择重新规划或其他处理
//             }
